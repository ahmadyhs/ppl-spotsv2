  ...
  return (
    <div className=" flex w-full flex-col bg-white items-center justify-between">
      ...
      <section className="bg-white-50 dark:bg-white-800">
        <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20">
          <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
            ...
            <Image className="mx-auto scale-75 rounded-md" src="/hands.png" width={770} height={1024} alt='hands' priority />
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#19E8E0] w-full py-8">
        <div className="container mx-auto flex flex-wrap pt-4 pb-12">
          <h2 className="w-full my-2 sm:text-5xl text-4xl font-bold leading-tight text-center text-gray-800">
            Bagaimana Alurnya?
          </h2>
