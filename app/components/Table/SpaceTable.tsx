            ...
            spaces.map((s) => {
              return (
                <tr className="flex w-full items-center" key={s.space_id}>
                  <td className="w-10 break-words p-2">{s.space_id}</td>
                  {userType === "ADMIN" && (
                    <td className="w-10 p-2">{s.space_id}</td>
                  )}
                  <td className="w-40 break-words p-2">{s.name}</td>
                  <td className="w-28 break-words p-2">
                    Rp {moneySplitter(s.price.toString())}
                  </td>
                  <td className="w-20 break-words p-2">{s.capacity}</td>
                  <td className="w-36 break-words p-2">{s.location.address}</td>
